...
public class DrawUtils extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (ArrayList<Integer> line : lines) {
            ...
            if (!rect.isEmpty()){
                ArrayList<Integer> l = LiangBarsky.calc(line, rect);
                if(!l.isEmpty()){
        ...
        for (ArrayList<Integer> line : polygon) {
            drawLine(line.get(0), line.get(1), line.get(2), line.get(3), cellSize, g, Color.BLUE);
    ...
    private void drawRectangles(ArrayList<Integer> rect, int cellSize, Graphics g){
        Graphics2D g2 = (Graphics2D)g;
