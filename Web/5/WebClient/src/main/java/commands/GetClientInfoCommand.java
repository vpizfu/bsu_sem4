...
public class GetClientInfoCommand implements ICommand {
    ...
    public GetClientInfoCommand(HttpServletResponse response, HttpServletRequest request, TourAgencyDbController controller, int clientId) {
    ...
    public void execute() {
        try {
            ...
            List list = Arrays.asList("Roman", "Kot");
